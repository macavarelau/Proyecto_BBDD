...
<?php
  ...
  require("../config/data.php");
 	...
 	$query = "SELECT DISTINCT pid, nombre FROM dblink('host=localhost user=$user2 dbname=$databaseName2 password=$password2 port=5432', 'SELECT rut as pid, nombre FROM personal');";
