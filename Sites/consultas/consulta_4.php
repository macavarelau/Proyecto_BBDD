...
<?php
  ...
  $query = "SELECT DISTINCT newtable2.bid, newtable2.nombre, newtable2.patente, newtable2.pais, newtable2.giro, newtable2.personal 
            ...
            OR (newtable.salida > newtable2.ingreso AND newtable.salida < newtable2.salida AND newtable2.pnombre = newtable.pnombre) and newtable2.nombre <> UPPER('$nombre_buque');";
